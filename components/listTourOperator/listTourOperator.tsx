...
interface ListTourOperatorProps {
  navigation: NavigationProp<any, any>;
}

export const ListTourOperator: FC<ListTourOperatorProps> = ({navigation}) => {
  const [tableDate, setTableDate] = useState({
    tableHead: ['Назва', 'Номер телефону', 'Адреса'],
    tableBoddy: [['432']],
  });
